...
export function DashboardPage() {
  ...
  return <div className="min-h-screen bg-[var(--background)] noise lg:flex">
    <aside className={`fixed inset-y-0 left-0 z-30 flex w-[260px] flex-col overflow-y-auto border-r border-[var(--line)] bg-[var(--panel)] p-5 transition-transform lg:sticky lg:top-0 lg:h-screen lg:translate-x-0 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}>
