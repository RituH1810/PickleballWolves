    ...
    <main className="min-h-screen bg-[#f3f5f2] px-5 py-8 noise sm:px-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          ...
          <span className="flex items-center gap-2 rounded-full bg-[#e4f3a8] px-4 py-2 text-xs font-bold text-[#5c7b1a]"><Check size={15} />{room.status === "LIVE" ? "Live schedule" : room.status}</span>
        </div>
        {notice && (
